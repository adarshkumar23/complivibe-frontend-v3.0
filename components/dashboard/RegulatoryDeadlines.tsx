...
export function RegulatoryDeadlines({ data }: { data: CommandCenter }) {
  ...
  return (
    <SectionCard title="Regulatory Deadlines" subtitle="Upcoming obligations" icon={CalendarClock} accent="amber">
      {deadlines.isLoading ? (
        <SkeletonRows rows={3} />
      ) : deadlines.isError ? (
