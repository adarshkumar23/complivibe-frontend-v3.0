...
const NAV: NavItem[] = [
  ...
  { label: "Policy Exceptions", icon: ClipboardCheck, href: "/dashboard/policy-exceptions", match: "prefix" },
  ...
  { label: "Data Observability", icon: Database, href: "/dashboard/data-observability", match: "exact" },
  { label: "Data Lineage", icon: Workflow, href: "/dashboard/data-observability/lineage", match: "prefix" },
  ...
  { label: "Risk Appetite & KRIs", icon: Activity, href: "/dashboard/risk-appetite", match: "prefix" },
  ...
  { label: "Exports", icon: FileBarChart, href: "/dashboard/exports", match: "prefix" },
  ...
  { label: "AI-BOM", icon: PackageCheck, href: "/dashboard/ai-bom", match: "prefix" },
