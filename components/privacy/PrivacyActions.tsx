...
import { FileCheck2, ScrollText, FilePlus, Download, Clock, type LucideIcon } from "lucide-react";
...
export function PrivacyActions() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <DisabledAction icon={FilePlus} label="Create privacy request" />
      <DisabledAction icon={Clock} label="Update retention policy" />
      <DisabledAction icon={Download} label="Export privacy pack" />
    </div>
  );
}
